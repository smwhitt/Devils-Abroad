...
\COPY Program(program_name,country) FROM 'Populate Program.csv' DELIMITER ',' CSV HEADER
\COPY Contact(email,name,major,term,program_name) FROM 'Populate Contact.csv' DELIMITER ',' CSV HEADER
\COPY MajorCodes(duke_major_code) FROM 'Populate MajorCodes.csv' DELIMITER ',' CSV HEADER
